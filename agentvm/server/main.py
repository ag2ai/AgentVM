...
def execute_command():
    ...
    timeout = data.get('timeout', 120)  # Default to 120 seconds (2 minutes) if not specified
    # print(f"[SERVER /execute] Received timeout from client: {data.get('timeout', 'NOT PROVIDED')}")
    # print(f"[SERVER /execute] Using timeout: {timeout} seconds")
    # print(f"[SERVER /execute] Command: {command}")
