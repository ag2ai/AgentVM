...
# TTL configuration
from agentvm.providers.aws.config import ENABLE_TTL, DEFAULT_TTL_MINUTES, AWS_SCHEDULER_ROLE_ARN
from agentvm.providers.aws.scheduler_utils import schedule_instance_termination
...
from agentvm.providers.base import VMManager

# Import proxy-related modules only when needed
try:
    from agentvm.providers.aws.proxy_pool import get_global_proxy_pool, init_proxy_pool
