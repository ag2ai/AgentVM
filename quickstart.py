...
parser.add_argument("--provider_name", type=str, default="apptainer")
parser.add_argument("--path_to_vm", type=str, default="/data/home/jjl7199/OSWorld/docker_vm_data/Ubuntu.qcow2")
