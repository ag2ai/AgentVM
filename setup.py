...
setup(
    name="agentvm",
    version="1.0.0",
    author="Yiran Wu, Jiale Liu, etc",
    author_email="ykw5399@psu.edu",
    description="The package provides a vitual machine interface for LLM agents to interact with the digital world.",
